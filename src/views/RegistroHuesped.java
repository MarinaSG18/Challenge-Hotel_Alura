...
public class RegistroHuesped extends JFrame {
	 ...
	 * 
	 */
	public RegistroHuesped(Integer id_reservacion) {
	 ...
	 * 
	 * */
	public RegistroHuesped(Huesped huespedSelec) {
		contenido("modificar");
		this.huesped = huespedSelec;
	...
	private void contenido(String usoVentana) {
		...
		String nomTitulo = "";
		String nomBoton = "";
		if (usoVentana == "registrar") {
			nomTitulo = "REGISTRO";
			nomBoton = "GUARDAR";
		}
		if (usoVentana == "modificar") {
			nomTitulo = "MODIFICACIÓN";
			nomBoton = "ACTUALIZAR";
		}

		JLabel lblTitulo = new JLabel(nomTitulo + " HUÉSPED");
		lblTitulo.setBounds(560, 55, 318, 42);
		...
		txtNreserva.setText(String.valueOf(id_reservacion));
		...
		JLabel labelGuardar = new JLabel(nomBoton);
	...
	private boolean validarCampos() {
		...
		boolean esTelefonoValido = txtTelefono.getText().matches("\\d{10}");
		
		if(!esTelefonoValido) {
			JOptionPane.showMessageDialog(null, "El campo telefono debe tener 10 digitos");
			return false;
		}
		return true;
	}
	...
	private void guardarHuesped() {
		...
		Integer id_reservacion = Integer.valueOf(txtNreserva.getText());
		Huesped huesped = new Huesped(txtNombre.getText(), txtApellido.getText(), txtFechaN.getDate(),
				txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), id_reservacion);
	...
	private void modificarHuesped() {
		...
		filasModificadas = this.huespedController.modificar(txtNombre.getText(), txtApellido.getText(),
				txtFechaN.getDate(), txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(),
				huesped.getId());

		JOptionPane.showMessageDialog(this, String.format("%d item modificado con éxito!", filasModificadas));
		ventanaBuscar("modificar");
